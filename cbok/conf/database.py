...
# for more details.
api_db_group = cfg.OptGroup('bookkeeping_database',
                            title='Bookkeeping Database Options',
                            help="""
The *CBoK Bookkeeping Database* is a separate database which is used for bookkeeping.
""")
...
def list_opts():
    ...
    # namespace "cbok.conf" and second under the namespace "oslo.db". This
    # is due to the setting in file "etc/cbok/cbok-config-generator.conf".
