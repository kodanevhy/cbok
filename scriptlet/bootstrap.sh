...
_cbok_export_func zsv_restart_mn
_cbok_export_func zsv_start_ui_if_needed
_cbok_export_func zsv_ensure_ui_started
_cbok_export_func zsv_wait_local_resources_ready
_cbok_export_func zsv_wait_resources_ready
_cbok_export_func zsv_discover_healthy_kvm_hosts_from_primary
_cbok_export_func zsv_discover_management_nodes
_cbok_export_func zsv_discover_ceph_primary_storage_nodes
_cbok_export_func zsv_discover_zbs_primary_storage_nodes
_cbok_export_func zsv_discover_imagestore_bs_nodes_from_primary
_cbok_export_func zsv_authorize_public_keys
...
_cbok_export_func zsv_scp_web_classes_archive_to_remote
_cbok_export_func zsv_remote_install_web_classes_archive
